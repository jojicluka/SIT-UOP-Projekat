...
import com.jojicluka.gui.VozacDashboard.VozacDashboard;
...
public class VozacLogin extends JFrame {
    ...
    public VozacLogin(TaxiSluzba taxiSluzba) {
        setTitle("Vozac login");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean verify = verifyLoginVozac(userCheck, passCheck);
                if(verify == true){
                    provera.setText("Login uspesan!");
                    String username = userCheck;
                    VozacDashboard vd = new VozacDashboard(taxiSluzba, username);
                    vd.setVisible(true); //ivica
                } else {
